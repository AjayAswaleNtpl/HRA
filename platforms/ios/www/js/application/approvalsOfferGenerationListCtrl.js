mainModule.controller('approvalsOfferGenerationListCtrl', function($scope,$rootScope,$timeout, $state, commonService, getYearListService, getYearListService, viewODApplicationService, viewLeaveApplicationService, detailsService, $ionicPopup, getSetService, $ionicLoading) {
    ...
    $scope.init = function(){
         ...
         //  fd.append("message","")
          ...
          // fd.append("workFlowRequestFlag","")
            $.ajax({
                url: (baseURL + '/rms/offerLetterGeneration/viewOfferLetterGen.spr'),
                data: fd,
                type: 'POST',
                async:false,
                ...
                success : function(success) {
                    ...
                    if (!(success.clientResponseMsg=="OK")){
                            ...
                            $scope.offerLetterGenForm = success.offerLetterGenForm
        ...
        $scope.openOfferLetterDetails = function(idx,offer){
            $rootScope.offerList = offer
            $state.go('approvalsViewOfferGenerationDetails')
        }
